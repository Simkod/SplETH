...
export const fetchBalanceAsync = createAsyncThunk<BalanceResponse, void, { state: RootState }>('contract/fetchBalanceAsync',
  (_: void, thunkAPI) => {
    thunkAPI.dispatch(setNeedFetchTransactionAction(true));
...
export const contractSlice = createSlice({
  ...
  reducers: {
    ...
    setNeedFetchTransaction: (state, action: PayloadAction<boolean>) => {
      state.needFetchTransaction = action.payload;
    }
  },
...
export const {
  ...
  setNeedFetchTransaction: setNeedFetchTransactionAction,
